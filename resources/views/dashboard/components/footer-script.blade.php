...
<script src="{{asset('assets/admin/plugins/extension-datatable/date-time/moment.js')}}"></script>
<script src="{{asset('assets/admin/plugins/extension-datatable/date-time/dataTables.dateTime.min.js')}}"></script>
<script src="{{asset('assets/admin/js/datetime-table.js')}}"></script>
<!-- DATA TABLE JS -->
<script src="{{asset('assets/admin/plugins/datatable/js/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('assets/admin/plugins/datatable/js/dataTables.bootstrap5.js')}}"></script>
...
<script src="{{asset('assets/admin/plugins/datatable/js/dataTables.buttons.min.js')}}"></script>
<script src="{{asset('assets/admin/plugins/datatable/js/buttons.bootstrap5.min.js')}}"></script>
<script src="{{asset('assets/admin/plugins/extension-datatable/autofill/dataTables.autoFill.min.js')}}"></script>
<script src="{{asset('assets/admin/plugins/extension-datatable/autofill/autoFill.bootstrap5.min.js')}}"></script>
<script src="{{asset('assets/admin/plugins/extension-datatable/keytable/dataTables.keyTable.min.js')}}"></script>
<script src="{{asset('assets/admin/js/autofill-table.js')}}"></script>
...
<script src="{{asset('assets/admin/plugins/edit-table/bst-edittable.js')}}"></script>
<script src="{{asset('assets/admin/plugins/edit-table/edit-table.js')}}"></script>
